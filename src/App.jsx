...
// // --- Company and Tech Logos ---
// const TcsLogo = () => <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdUIhQCTegyuo6ZuTmrG8m2Qt73AXaVN9z2w&s" alt="TCS Logo" className="w-6 h-6 object-contain"/>;
// const ScuLogo = () => <img src="https://upload.wikimedia.org/wikipedia/en/thumb/a/ad/Santa_Clara_U_Seal.svg/1200px-Santa_Clara_U_Seal.svg.png" alt="SCU Logo" className="w-6 h-6"/>;
// const LntLogo = () => <img src="https://www.nbmcw.com/images/news/Larsen-Toubro.webp" alt="L&T Logo" className="w-6 h-6 object-contain"/>;
...
//       { role: "Software Engineer-Backend", company: "Tata Consultancy Services", date: "Aug 2021 - Sep 2022", description: "Engineered and deployed Java-based microservices in a containerized AWS EKS environment, automating critical processes and reducing manual efforts by 95%. Built efficient data pipelines with Redis caching, boosting ML model performance by 33%.", logo: <TcsLogo /> },
//       { role: "Software Engineer-Data Intern", company: "Larsen and Toubro Technology Services", date: "June 2021 - Aug 2021", description: "Constructed ETL pipelines using PySpark and Scala within a Kubernetes cluster, significantly enhancing data quality and delivery by 69%. Implemented advanced SQL caching to improve query performance by 2.5x.", logo: <LntLogo /> }
//     ],
//     projects: [
//       { title: "Bronco Career Alerts", description: "Architected a distributed Pub-Sub system for real-time job alerts using RabbitMQ, Docker, and Kubernetes. Engineered the system to ensure high availability and fault tolerance through replication and mutual exclusion.", tags: ["Java", "Python", "RabbitMQ", "Docker", "Kubernetes"], link: "#" },
//       { title: "House Leasing Application", description: "Built a full-stack house leasing platform with a secure Spring Boot backend, MongoDB database, and AWS S3 for file storage. Engineered a containerized deployment using Docker for scalability and portability.", tags: ["Spring Boot", "MongoDB", "AWS S3", "Docker", "REST APIs"], link: "#" },
//       { title: "Recursive DNS Resolver", description: "Constructed a high-performance DNS resolver in Golang from the ground up. Implemented a custom caching mechanism with TTL to minimize latency and optimize network requests for various record types.", tags: ["Golang", "DNS", "Caching", "Web Protocols"], link: "#" },
//       { title: "CI/CD on AWS EKS", description: "Designed and implemented a complete, scalable CI/CD pipeline on AWS. Built the infrastructure using CodeCommit, CodePipeline, and ECR to automate the deployment of containerized workloads on EKS Fargate.", tags: ["AWS EKS", "CI/CD", "Fargate", "VPC", "Docker"], link: "#" }
//     ],
//     skills: {
//       "Languages": ["Java", "Golang", "Python", "JavaScript", "C/C++", "SQL"],
//       "Frameworks & Libraries": ["Spring Boot", "Hibernate", "Kafka", "RabbitMQ", "Flask", "Spark"],
//       "Databases & Caching": ["MySQL", "MongoDB", "PostgreSQL", "Redis", "MariaDB"],
//       "DevOps & Cloud": ["Docker", "Kubernetes", "Git", "Jenkins", "JIRA", "AWS", "Postman"]
//     }
...
//           </nav>
//           <div className="flex items-center gap-4">
//             <a href={portfolioData.resumeUrl} download className="hidden md:inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-cyan-600 bg-cyan-100/50 dark:bg-cyan-900/50 dark:text-cyan-300 rounded-lg hover:bg-cyan-100 dark:hover:bg-cyan-900 transition-all duration-300">
...
//                             </div>
//                             <p className="block my-1 text-md font-normal text-gray-500 dark:text-gray-400">{job.company}</p>
//                             <p className="text-base text-gray-600 dark:text-gray-400 mt-2">{job.description}</p>
//                         </div>
//                     </div>
//                 ))}
//             </div>
...
//                                 </a>
//                             </div>
//                             <p className="text-gray-600 dark:text-gray-400 mb-6 min-h-[100px]">{project.description}</p>
//                             <div className="flex flex-wrap gap-2">
//                                 {project.tags.map(tag => (
//                                     <span key={tag} className="px-3 py-1 text-sm font-medium text-teal-800 bg-teal-100 rounded-full dark:bg-teal-900/50 dark:text-teal-300">{tag}</span>
//                                 ))}
...
//                             {skillsList.map(skill => (
//                                 <div key={skill} className="flex flex-col items-center gap-2 p-3 bg-gray-200 dark:bg-gray-800 rounded-lg transition-all duration-300 hover:bg-cyan-500 hover:text-white dark:hover:bg-cyan-500 cursor-default">
//                                     <img src={techLogos[skill]} alt={`${skill} logo`} className="w-8 h-8"/>
